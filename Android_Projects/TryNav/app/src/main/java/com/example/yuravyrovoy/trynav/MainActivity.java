...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.itemInfo) {
            Toast.makeText(this, "nav Info", Toast.LENGTH_LONG ).show();
        } else if (id == R.id.intemShare) {
            Toast.makeText(this, "nav Share", Toast.LENGTH_LONG ).show();
        } else if (id == R.id.intemSettings) {
            Toast.makeText(this, "nav Settings", Toast.LENGTH_LONG ).show();
        }
